...
import lippia.web.constants.AutomationConstants_MYACCOUNT;
...
public class AutomationPracticeServiceMYACCOUNT {
    ...
    public static void visualizarDetalleMyAccount(){
        WebElement elemento = DriverManager.getDriverInstance().findElement(By.xpath("//*[@id=\"page-36\"]/div/div[1]/div/form"));
        assert elemento.isDisplayed() : "El elemento no se encuentra visible en la pantalla.";
    }

    public static void clickDetalleCuenta(){
        click(AutomationConstants_MYACCOUNT.MI_CUENTA_DETALLE);
    }
